...
class Email {
    ...
    public function enviarConfirmacion(){
        ...
        $contenido .= " <a  style='color: #267A91;  margin-left:auto; margin-right:auto;' href='/confirmar-cuenta?token= ".$this->token. "'><button
    ...
    public function enviarInstrucciones(){
        ...
        $contenido .= "<div style='display:flex; justify-content:center'>";
        $contenido .= " <a  style='color: #267A91;  margin-left:auto; margin-right:auto;' href='/recuperar?token= ".$this->token. "'><button 
        style=' background-color: #00a3ff;
        padding: 15px 15px;
        color: white;
        margin-left:auto; 
